...
import * as Web$dDOM$dDocument$dCompatMode from "../Web.DOM.Document.CompatMode/index.js";
...
const compatMode = doc => {
  const $0 = _compatMode(doc);
  return () => {
    const a$p = $0();
    return a$p === "BackCompat" ? Web$dDOM$dDocument$dCompatMode.BackCompat : Web$dDOM$dDocument$dCompatMode.CSS1Compat;
  };
};
export {
  compatMode,
